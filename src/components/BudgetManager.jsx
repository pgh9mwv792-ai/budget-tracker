    ...
    <div className="px-4 py-3">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={save}
            className="rounded-md bg-slate-900 dark:bg-emerald-600 text-white text-xs font-medium px-2.5 py-1 hover:bg-slate-800 dark:hover:bg-emerald-500 transition"
          >
            Save
          </button>
          {hasBudget && (
